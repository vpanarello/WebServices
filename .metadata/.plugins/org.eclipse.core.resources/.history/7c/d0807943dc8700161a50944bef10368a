...
public class ObjectFactory {
    ...
    private final static QName _IOException_QNAME = new QName("http://exemplos.ws.fiap.com/", "IOException");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exemplos.ws.fiap.com/", name = "IOException")
